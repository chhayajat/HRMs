...
import { Clock, CalendarCheck, HelpCircle, CheckCircle, PlusCircle, Sparkles } from 'lucide-react';
...
const Attendance = () => {
  ...
  const fetchAttendanceHistory = async () => {
    ...
    try {
      ...
      const res = await apiCall(`/attendance?employeeId=${user.employeeProfileId._id}&startDate=${startStr}&endDate=${todayStr}`);
      if (res.success) {
        setHistory(res.data);
      }
    } catch (err) {
