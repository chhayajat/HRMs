...
const Leaves = () => {
  ...
  const fetchLeaveData = async () => {
    ...
    try {
      ...
      // Fetch balances
      const balRes = await apiCall(`/leaves/balances?employeeId=${user.employeeProfileId._id}`);
      if (balRes.success) {
        setBalances(balRes.data);
      }

      // Fetch history
      const historyRes = await apiCall(`/leaves?employeeId=${user.employeeProfileId._id}`);
